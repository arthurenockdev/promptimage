...
import {Sparkles, MoreVertical, Trash2, ImageIcon, Plus, LayoutDashboard, Download, LogOut, Settings, User, X } from 'lucide-react';
        ...
        <main className="flex-1 overflow-y-auto p-4">
          <div className="max-w-7xl mx-auto">
            <div className="flex justify-between items-center mb-6">
              <h1 className="text-3xl font-bold">Your Generated Visuals</h1>
              ...
              <>
                ...
                {visuals.length === 0 && !isLoading && (
                  <div className="text-center py-12 border-2 border-dashed rounded-lg">
                    ...
                    <Button
                      className="mt-4"
                      //onClick={() => router.push('/generate_visual')}
                    >
